...
class SettingsActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val ICON_OPEN_EXTERNAL = "M19,19H5V5h7V3H5c-1.11,0 -2,0.9 -2,2v14c0,1.1 0.9,2 2,2h14c1.1,0 2,-0.9 2,-2v-7h-2v7zM14,3v2h3.59l-9.83,9.83 1.41,1.41L19,6.41V10h2V3h-7z"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        header.addView(ImageView(this).apply {
            setImageDrawable(buildVectorDrawable(ICON_BACK, Color.WHITE, 44))
        ...
        // شورت‌کات به تنظیمات VPN این برنامه در تنظیمات سیستم
        list.addView(
            shortcutCard(
                title = "تنظیمات VPN سیستم",
                subtitle = "برای فعال‌سازی Always-on VPN و «مسدود کردن اتصال بدون VPN»، اینجا را لمس کن",
                iconPath = ICON_OPEN_EXTERNAL,
                onClick = { openVpnSettings() }
            )
        )
    ...
    private fun openVpnSettings() {
        ...
        if (!first) {
            // برخی دستگاه‌ها action استاندارد ندارند؛ fallback به نام خام
            try {
    ...
    /** یک کارت کلیک‌پذیر (شورت‌کات) با آیکون، هماهنگ با بقیه کارت‌ها. */
        ...
        return LinearLayout(this).apply {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                background = GradientDrawable().apply {
                    ...
                    cornerRadius = 24f
                    setStroke(2, Color.parseColor("#4C8DFF"))
                }
            }
            ...
            // فلش کوچک سمت راست (نشانه‌ی قابل‌کلیک بودن)
